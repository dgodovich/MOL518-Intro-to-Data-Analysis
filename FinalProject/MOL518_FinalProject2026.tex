...
For this project you may use AI anyway you like to get to a final answer, including asking it to solve the whole thing! You will turn in a Jupyter notebook that contains the code and any analysis outputs.

\textbf{For any code that is written by AI}, please add your own comments to the code to explain what it does and how it works. Start the comment with your initials, i.e. 
\begin{verbatim}
